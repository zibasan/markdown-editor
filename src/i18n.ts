...
const ja: TranslationDict = {
  ...
  // === 確認パレット ===
  'confirm.exportAndClose': 'エクスポートして閉じる',
  'confirm.exportAndCloseDesc': '編集内容を保存し、エクスポートしてからタブを閉じる',
  'confirm.closeWithoutExport': 'エクスポートせずに閉じる',
  'confirm.closeWithoutExportDesc': '何もせずにタブを閉じます',
...
const en: TranslationDict = {
  ...
  // === Confirm palette ===
  'confirm.exportAndClose': 'Export and Close',
  'confirm.exportAndCloseDesc': 'Save and export before closing the tab',
  'confirm.closeWithoutExport': 'Close Without Export',
  'confirm.closeWithoutExportDesc': 'Close the tab without saving',
